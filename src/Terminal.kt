...
// Escape sequences to change terminal color, see https://stackoverflow.com/questions/5762491/how-to-print-color-in-console-using-system-out-println
...
fun colorPrint(message: Any?, color: TerminalColor = TerminalColor.BLACK) {
    print("${color}${message}${TerminalColor.RESET}")
}

fun clearLine() = print("\r\u001b[K")

fun progressBar(x: Int, outOf: Int, color: TerminalColor = TerminalColor.GREEN) {
    clearLine()
